...
| [`02-anthropic-claude/`](02-anthropic-claude/) | opus-5, sonnet-5, opus-4-8, opus-4-7, haiku-4-5, fable-5, fable-5.1 | fable-5.1 **runtime** only (mantle: *does not exist*) · the rest **both** (runtime: profile-only; mantle: which Claudes, by Region, is what [§11](02-anthropic-claude/01-messages-api-core.ipynb) enumerates) | Messages | Core inference · adaptive thinking, tool loops, caching · computer use, memory, compaction |
